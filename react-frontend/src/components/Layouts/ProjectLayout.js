...
import MaklumatDaerahPage from "../MaklumatDaerahPage/MaklumatDaerahPage";
import ParlimenPage from "../ParlimenPage/ParlimenPage";
import DunPage from "../DunPage/DunPage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("maklumatDaerah");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "maklumatDaerah",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "maklumatDaerah" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "maklumatDaerah",
                      "text-black": props?.currentActiveTab2 !== "maklumatDaerah",
                    })}
                  >
                  Maklumat Daerah
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "maklumatDaerah",
                      "text-yellow-700": props?.currentActiveTab2 !== "maklumatDaerah",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("parlimen");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "parlimen",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "parlimen" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "parlimen",
                      "text-black": props?.currentActiveTab2 !== "parlimen",
                    })}
                  >
                  Parlimen
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "parlimen",
                      "text-yellow-700": props?.currentActiveTab2 !== "parlimen",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("dun");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "dun",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "dun" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "dun",
                      "text-black": props?.currentActiveTab2 !== "dun",
                    })}
                  >
                  Dun
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "dun",
                      "text-yellow-700": props?.currentActiveTab2 !== "dun",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>

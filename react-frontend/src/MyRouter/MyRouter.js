...
import SingleMaklumatDaerahPage from "../components/MaklumatDaerahPage/SingleMaklumatDaerahPage";
import MaklumatDaerahProjectLayoutPage from "../components/MaklumatDaerahPage/MaklumatDaerahProjectLayoutPage";
import SingleParlimenPage from "../components/ParlimenPage/SingleParlimenPage";
import ParlimanProjectLayoutPage from "../components/ParlimenPage/ParlimanProjectLayoutPage";
import SingleDunPage from "../components/DunPage/SingleDunPage";
import DunProjectLayoutPage from "../components/DunPage/DunProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/maklumatDaerah/:singleMaklumatDaerahId" exact element={<SingleMaklumatDaerahPage />} />
<Route path="/maklumatDaerah" exact element={<MaklumatDaerahProjectLayoutPage />} />
<Route path="/parlimen/:singleParlimenId" exact element={<SingleParlimenPage />} />
<Route path="/parlimen" exact element={<ParlimanProjectLayoutPage />} />
<Route path="/dun/:singleDunId" exact element={<SingleDunPage />} />
<Route path="/dun" exact element={<DunProjectLayoutPage />} />

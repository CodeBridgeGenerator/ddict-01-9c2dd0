...
const maklumatDaerah = require("./maklumatDaerah/maklumatDaerah.service.js");
const parlimen = require("./parlimen/parlimen.service.js");
const dun = require("./dun/dun.service.js");
...
module.exports = function (app) {
  ...
  app.configure(maklumatDaerah);
  app.configure(parlimen);
  app.configure(dun);
